...
A Typescript-based cmake-wrapper and task-runner that simplifies C/C++ project configuration and builds, spiritual successor to [fips](https://github.com/floooh/fips).
